"""
Charlotte Custom Connectors
===========================

This module helps Charlotte run via an external connector.
...
from charlotte.utils.globals.messages import connector_greetings
    ...
    def blueprint(self, on_new_message):
        ...
        async def receive(request):
            ...
            if intent == 'actions.intent.MAIN':
                message = choice(connector_greetings)
            else:
