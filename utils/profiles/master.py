"""
Charlotte Master Profile Creator
================================

This module creates Master user profile.
The module captures the data from the user and saves it in `./users/master.yml`
file. The data stored, is encrypted using a key which the user provides while
setting up his/her profile.
