"""
Charlotte Cryptography Module
=============================

This module encrypts and decrypts any string.
The module has 3 functions:
    - keygen    : Generates a 32-character long key
    - cipher    : Encrypts the data.
    - decipher  : Decrypts the data.
